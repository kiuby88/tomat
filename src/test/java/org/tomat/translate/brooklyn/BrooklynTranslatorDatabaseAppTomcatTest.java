 ...
 */
public class BrooklynTranslatorDatabaseAppTomcatTest {

    DefinitionParser definitionParser;
    String AWSApplicationDatabaseFile =
            "src/test/resources/toscaTopology/AWS-Application-DatabaseSample-Tomcat.xml";
    ...
    String yamlFile="src/test/resources/yaml/testDbAppTomcat.yaml";

    //TODO refactor test to init using less code
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(BrooklynTranslatorDatabaseAppTomcatTest.class);
    }
