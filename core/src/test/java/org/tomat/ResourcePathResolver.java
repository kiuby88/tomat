...
public class ResourcePathResolver {
    ...
    final public static String AWS_LOCATION_SIMPLE_TOPOLOGY = TOPOLOGY_FOLDER + "AWS-Location-Simple_Topology.xml";
    ...
    final public static String AWS_LOCATION_SAMPLE_MALFORMED_RELATION_NODES = TOPOLOGY_FOLDER + "AWS-Location-Sample-MalFormedRelation_Nodes.xml";
    ...
    final public static String AWS_NOT_ARTIFACT_TEMPLATE = TOPOLOGY_FOLDER + "AWS-NotArtifactTemplate.xml";
    final public static String AWS_NOT_DEPLOYMENT_ARTIFACT = TOPOLOGY_FOLDER + "AWS-NotDeploymentArtifact.xml";
    final public static String AWS_NOT_DEPLOYMENT_ARTIFACT_SPECIFICATION = TOPOLOGY_FOLDER + "AWS-NotDeploymentArtifactsSpecification.xml";
    final public static String AWS_NOT_NODETYPE_IMPLEMENTATION= TOPOLOGY_FOLDER + "AWS-NotNodeTypeImplementation.xml";
    final public static String AWS_NOT_NODETYPE_DEFINITION= TOPOLOGY_FOLDER + "AWS-NotNodeTypeDefinition.xml";
